...
import fontdroid.TypefaceCache;
import fontdroid.TypefaceCache.PathType;

import fontdroid.StringUtility;
import me.grantland.widget.AutofitTextView;
import ir.edusa.parents.Helpers.NumberHelper;
 ...
 */
public class RTextView extends AutofitTextView {

    /**
     * @param context
     */
    public RTextView(final Context context) {
        super(context);
    }
     ...
     * @param attributeSet
     */
    public RTextView(final Context context, final AttributeSet attributeSet) {
     ...
     * @param defStyle
     */
    public RTextView(final Context context, final AttributeSet attributeSet, final int defStyle) {
    ...
    public void setText(CharSequence text, TextView.BufferType type) {
        if (text != null) {
            super.setText(NumberHelper.with().toPersianNumber(text.toString()), type);
        } else {
